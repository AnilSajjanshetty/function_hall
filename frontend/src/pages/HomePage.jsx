  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 py-16 px-4">
        <div className="container mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-white flex items-center justify-center">
            <Bell className="w-10 h-10 mr-3 animate-bounce" /> Latest Announcements
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            {announcements.slice(0, 3).map((ann) => (
              <div key={ann.id} className="bg-white rounded-xl shadow-2xl p-6 transform hover:scale-105 transition-all">
          ...
          <div className="text-center mt-8">
            <Link to="/announcements" className="bg-white text-purple-600 px-8 py-3 rounded-full font-semibold">
              View All
            </Link>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-pink-50 to-purple-50 py-20 px-4">
        <div className="container mx-auto">
          <h2 className="text-5xl font-bold text-center mb-4 text-purple-900">Recent Events</h2>
            ...
            {recentEvents.map(event => (
              <div key={event.id} className="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <Link to="/gallery" className="mt-4 inline-block bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-2 rounded-lg">
                    View Gallery
                  </Link>
                </div>
              </div>
